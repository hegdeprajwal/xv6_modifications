...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 a9 03 00 00       	call   3e3 <unlink>
 ...
 6a1:	a1 14 0c 00 00       	mov    0xc14,%eax
{
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 14 0c 00 00    	mov    %edx,0xc14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 14 0c 00 00    	mov    0xc14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d 14 0c 00 00    	mov    0xc14,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 14 0c 00 00    	mov    0xc14,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 14 0c 00 00    	mov    %edx,0xc14
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 14 0c 00 00 18 	movl   $0xc18,0xc14
 7f7:	0c 00 00 
    base.s.size = 0;
 7fa:	bf 18 0c 00 00       	mov    $0xc18,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 18 0c 00 00 18 	movl   $0xc18,0xc18
 806:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 1c 0c 00 00 00 	movl   $0x0,0xc1c
 812:	00 00 00 
    if(p->s.size >= nunits){
