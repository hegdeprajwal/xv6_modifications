...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 f3 0e 00 00       	call   f23 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 86 0e 00 00       	call   edb <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 84 0e 00 00       	call   eeb <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 50 0e 00 00       	call   f0b <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 5e 0e 00 00       	call   f53 <chdir>
  ...
  exit();
     11a:	e8 c4 0d 00 00       	call   ee3 <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 59 0d 00 00       	call   ee3 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 40 0d 00 00       	call   edb <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 38 0d 00 00       	call   f1b <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 de 0c 00 00       	call   ee3 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 d4 0c 00 00       	call   ef3 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 bc 0c 00 00       	call   f0b <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 b3 0c 00 00       	call   f0b <close>
    wait();
     258:	e8 8e 0c 00 00       	call   eeb <wait>
    wait();
     25d:	e8 89 0c 00 00       	call   eeb <wait>
    break;
    ...
    wait();
     270:	e8 76 0c 00 00       	call   eeb <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 80 0c 00 00       	call   f0b <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 8b 0c 00 00       	call   f23 <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 89 0d 00 00       	call   1050 <printf>
      exit();
     2c7:	e8 17 0c 00 00       	call   ee3 <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 28 0c 00 00       	call   f0b <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 6f 0c 00 00       	call   f5b <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 16 0c 00 00       	call   f0b <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 0d 0c 00 00       	call   f0b <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 fa 0b 00 00       	call   f0b <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 41 0c 00 00       	call   f5b <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 e8 0b 00 00       	call   f0b <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 df 0b 00 00       	call   f0b <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 44 1b 00 00       	push   $0x1b44
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 44 1b 00 00       	push   $0x1b44
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 3c 1b 00 00       	push   $0x1b3c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 44 1b 00 00       	push   $0x1b44
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 44 1b 00 00       	push   $0x1b44
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 ee 01 00 00       	call   efb <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 b1 01 00 00       	call   f23 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 b4 01 00 00       	call   f3b <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 7a 01 00 00       	call   f0b <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
  ...
  return clone(start_routine, arg1, arg2, stack);
     ...
     e3a:	e8 44 01 00 00       	call   f83 <clone>
}
     e3f:	c9                   	leave  
     e40:	c3                   	ret    
...
thread_join() 
{
     ...
     e53:	83 ec 34             	sub    $0x34,%esp
  void *stack;
  int ret_pid = join(&stack);
     e56:	8d 45 f4             	lea    -0xc(%ebp),%eax
     e59:	50                   	push   %eax
     e5a:	e8 2c 01 00 00       	call   f8b <join>

  if (ret_pid != -1) 
     e5f:	83 c4 10             	add    $0x10,%esp
     e62:	83 f8 ff             	cmp    $0xffffffff,%eax
     e65:	75 09                	jne    e70 <thread_join+0x20>
    free(stack);
  }
  ...
  return ret_pid;
    ...
    free(stack);
     ...
     e73:	ff 75 f4             	push   -0xc(%ebp)
     e76:	89 45 e4             	mov    %eax,-0x1c(%ebp)
     e79:	e8 72 03 00 00       	call   11f0 <free>
     e7e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
void lock_init(lock_t *lock)
{
  ...
  lock->ticket = 0;
     e96:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  lock->turn = 0;
     e9d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
     ea3:	5d                   	pop    %ebp
     ea4:	c3                   	ret    
     ea5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
void lock_acquire(lock_t *lock){
    ...
    __asm__ volatile
     ebb:	f0 0f c1 42 04       	lock xadd %eax,0x4(%edx)
  int myTurn = fetch_and_add(&lock->ticket , 1);
  while ( lock->turn != myTurn) 
     ec0:	8b 12                	mov    (%edx),%edx
     ec2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
     ec8:	39 c2                	cmp    %eax,%edx
     eca:	75 fc                	jne    ec8 <lock_acquire+0x18>
  {}; // keep spinning
}
     ecc:	5d                   	pop    %ebp
     ecd:	c3                   	ret    
     ...
     fac:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    101e:	56                   	push   %esi
    101f:	57                   	push   %edi
    1020:	e8 de fe ff ff       	call   f03 <write>
  while(--i >= 0)
    ...
    1059:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1095:	57                   	push   %edi
    1096:	56                   	push   %esi
    1097:	e8 67 fe ff ff       	call   f03 <write>
  ...
  write(fd, &c, 1);
    ...
    10ff:	57                   	push   %edi
    1100:	56                   	push   %esi
    1101:	e8 fd fd ff ff       	call   f03 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    116b:	57                   	push   %edi
    116c:	56                   	push   %esi
    116d:	e8 91 fd ff ff       	call   f03 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    11af:	e8 4f fd ff ff       	call   f03 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12e3:	e8 83 fc ff ff       	call   f6b <sbrk>
  if(p == (char*)-1)
