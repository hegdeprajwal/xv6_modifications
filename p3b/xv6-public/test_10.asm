...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 3c 05 00 00       	call   553 <getpid>
  ...
  1a:	c7 45 f0 23 00 00 00 	movl   $0x23,-0x10(%ebp)
   ppid = getpid();
  21:	a3 d8 0d 00 00       	mov    %eax,0xdd8
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 2);
  51:	83 3d d4 0d 00 00 02 	cmpl   $0x2,0xdd4
  ...
  91:	68 d4 09 00 00       	push   $0x9d4
  96:	68 89 09 00 00       	push   $0x989
  9b:	6a 01                	push   $0x1
  9d:	e8 9e 05 00 00       	call   640 <printf>
  a2:	5a                   	pop    %edx
  a3:	59                   	pop    %ecx
  a4:	68 9d 09 00 00       	push   $0x99d
  a9:	6a 01                	push   $0x1
  ab:	e8 90 05 00 00       	call   640 <printf>
  b0:	5b                   	pop    %ebx
  b1:	ff 35 d8 0d 00 00    	push   0xdd8
  b7:	e8 47 04 00 00       	call   503 <kill>
  bc:	e8 12 04 00 00       	call   4d3 <exit>
   assert(thread_pid > 0);
  c1:	6a 1f                	push   $0x1f
  ...
  d7:	68 c5 09 00 00       	push   $0x9c5
  dc:	eb b8                	jmp    96 <main+0x96>

   printf(1, "TEST PASSED\n");
  de:	50                   	push   %eax
  df:	50                   	push   %eax
  e0:	68 f7 09 00 00       	push   $0x9f7
  e5:	6a 01                	push   $0x1
  e7:	e8 54 05 00 00       	call   640 <printf>
   exit();
  ec:	e8 e2 03 00 00       	call   4d3 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 116:	75 2a                	jne    142 <worker+0x42>
   assert(global == 1);
 118:	83 3d d4 0d 00 00 01 	cmpl   $0x1,0xdd4
 11f:	0f 84 80 00 00 00    	je     1a5 <worker+0xa5>
 125:	6a 2f                	push   $0x2f
 127:	68 68 09 00 00       	push   $0x968
 12c:	68 72 09 00 00       	push   $0x972
 131:	6a 01                	push   $0x1
 133:	e8 08 05 00 00       	call   640 <printf>
 138:	83 c4 0c             	add    $0xc,%esp
 13b:	68 b9 09 00 00       	push   $0x9b9
 140:	eb 1b                	jmp    15d <worker+0x5d>
   assert(arg2_int == 42);
 142:	6a 2e                	push   $0x2e
 144:	68 68 09 00 00       	push   $0x968
 149:	68 72 09 00 00       	push   $0x972
 14e:	6a 01                	push   $0x1
 150:	e8 eb 04 00 00       	call   640 <printf>
 155:	83 c4 0c             	add    $0xc,%esp
 158:	68 aa 09 00 00       	push   $0x9aa
 15d:	68 89 09 00 00       	push   $0x989
 162:	6a 01                	push   $0x1
 164:	e8 d7 04 00 00       	call   640 <printf>
 169:	58                   	pop    %eax
 16a:	5a                   	pop    %edx
 16b:	68 9d 09 00 00       	push   $0x99d
 170:	6a 01                	push   $0x1
 172:	e8 c9 04 00 00       	call   640 <printf>
 177:	59                   	pop    %ecx
 178:	ff 35 d8 0d 00 00    	push   0xdd8
 17e:	e8 80 03 00 00       	call   503 <kill>
 183:	e8 4b 03 00 00       	call   4d3 <exit>
   assert(arg1_int == 35);
 188:	6a 2d                	push   $0x2d
 18a:	68 68 09 00 00       	push   $0x968
 18f:	68 72 09 00 00       	push   $0x972
 194:	6a 01                	push   $0x1
 196:	e8 a5 04 00 00       	call   640 <printf>
 19b:	83 c4 0c             	add    $0xc,%esp
 19e:	68 7a 09 00 00       	push   $0x97a
 1a3:	eb b8                	jmp    15d <worker+0x5d>
   global++;
 1a5:	c7 05 d4 0d 00 00 02 	movl   $0x2,0xdd4
 1ac:	00 00 00 
   exit();
 1af:	e8 1f 03 00 00       	call   4d3 <exit>
 ...
 2e9:	31 db                	xor    %ebx,%ebx
{
 ...
 2f5:	57                   	push   %edi
 2f6:	6a 00                	push   $0x0
 2f8:	e8 ee 01 00 00       	call   4eb <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 35d:	e8 b1 01 00 00       	call   513 <open>
  if(fd < 0)
 ...
 371:	50                   	push   %eax
 372:	e8 b4 01 00 00       	call   52b <fstat>
  close(fd);
 377:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 37a:	89 c6                	mov    %eax,%esi
  close(fd);
 37c:	e8 7a 01 00 00       	call   4fb <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 41b:	e8 50 04 00 00       	call   870 <malloc>
  // printf(1 , "%d" , stack);
 ...
 42a:	e8 44 01 00 00       	call   573 <clone>
}
 42f:	c9                   	leave  
 430:	c3                   	ret    
...
thread_join() 
{
 ...
 443:	83 ec 34             	sub    $0x34,%esp
  void *stack;
  int ret_pid = join(&stack);
 446:	8d 45 f4             	lea    -0xc(%ebp),%eax
 449:	50                   	push   %eax
 44a:	e8 2c 01 00 00       	call   57b <join>

  if (ret_pid != -1) 
 44f:	83 c4 10             	add    $0x10,%esp
 452:	83 f8 ff             	cmp    $0xffffffff,%eax
 455:	75 09                	jne    460 <thread_join+0x20>
    free(stack);
  }
 ...
 469:	e8 72 03 00 00       	call   7e0 <free>
...
void lock_init(lock_t *lock)
{
 ...
 483:	8b 45 08             	mov    0x8(%ebp),%eax
  lock->ticket = 0;
 486:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  lock->turn = 0;
 ...
 59c:	89 d1                	mov    %edx,%ecx
{
 ...
 5c9:	0f b6 92 64 0a 00 00 	movzbl 0xa64(%edx),%edx
 ...
 649:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6b9:	ff 24 85 0c 0a 00 00 	jmp    *0xa0c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7c7:	90                   	nop
          s = "(null)";
 7c8:	ba 04 0a 00 00       	mov    $0xa04,%edx
        while(*s != 0){
 ...
 7e1:	a1 dc 0d 00 00       	mov    0xddc,%eax
{
 ...
 821:	5b                   	pop    %ebx
  freep = p;
 822:	89 15 dc 0d 00 00    	mov    %edx,0xddc
}
 828:	5e                   	pop    %esi
 829:	5f                   	pop    %edi
 82a:	5d                   	pop    %ebp
 ...
 859:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 85c:	89 15 dc 0d 00 00    	mov    %edx,0xddc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 879:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 87c:	8b 3d dc 0d 00 00    	mov    0xddc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8bf:	73 4f                	jae    910 <malloc+0xa0>
    ...
    if(p == freep)
 8c1:	8b 3d dc 0d 00 00    	mov    0xddc,%edi
 ...
 8ea:	e8 f1 fe ff ff       	call   7e0 <free>
  return freep;
 8ef:	8b 15 dc 0d 00 00    	mov    0xddc,%edx
 ...
 92f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 930:	c7 05 dc 0d 00 00 e0 	movl   $0xde0,0xddc
 937:	0d 00 00 
    base.s.size = 0;
 93a:	bf e0 0d 00 00       	mov    $0xde0,%edi
    base.s.ptr = freep = prevp = &base;
 93f:	c7 05 e0 0d 00 00 e0 	movl   $0xde0,0xde0
 946:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 949:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 94b:	c7 05 e4 0d 00 00 00 	movl   $0x0,0xde4
 952:	00 00 00 
    if(p->s.size >= nunits){
