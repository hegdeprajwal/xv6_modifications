   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 26 05 00 00       	call   543 <getpid>
  1d:	a3 ec 0d 00 00       	mov    %eax,0xdec

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 e8 0d 00 00 01 	movl   $0x1,0xde8
  2f:	00 00 00 
  ...
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 e8 0d 00 00       	mov    0xde8,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 da 04 00 00       	call   54b <sbrk>
  ...
  8d:	e8 9e 05 00 00       	call   630 <printf>
   exit();
  92:	e8 2c 04 00 00       	call   4c3 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  ...
  cc:	5b                   	pop    %ebx
  cd:	ff 35 ec 0d 00 00    	push   0xdec
  d3:	e8 1b 04 00 00       	call   4f3 <kill>
  d8:	e8 e6 03 00 00       	call   4c3 <exit>
  dd:	6a 22                	push   $0x22
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 e8 0d 00 00       	mov    0xde8,%eax
 ...
 185:	59                   	pop    %ecx
 186:	ff 35 ec 0d 00 00    	push   0xdec
 18c:	e8 62 03 00 00       	call   4f3 <kill>
 191:	e8 2d 03 00 00       	call   4c3 <exit>
   global += 4;
 196:	a1 e8 0d 00 00       	mov    0xde8,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 e8 0d 00 00       	mov    %eax,0xde8
   exit();
 1a3:	e8 1b 03 00 00       	call   4c3 <exit>
...
free(void *ap)
{
 ...
 7d1:	a1 f0 0d 00 00       	mov    0xdf0,%eax
{
 ...
 811:	5b                   	pop    %ebx
  freep = p;
 812:	89 15 f0 0d 00 00    	mov    %edx,0xdf0
}
 818:	5e                   	pop    %esi
 819:	5f                   	pop    %edi
 81a:	5d                   	pop    %ebp
 ...
 849:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 84c:	89 15 f0 0d 00 00    	mov    %edx,0xdf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 869:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 86c:	8b 3d f0 0d 00 00    	mov    0xdf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8af:	73 4f                	jae    900 <malloc+0xa0>
    ...
    if(p == freep)
 8b1:	8b 3d f0 0d 00 00    	mov    0xdf0,%edi
 ...
 8da:	e8 f1 fe ff ff       	call   7d0 <free>
  return freep;
 8df:	8b 15 f0 0d 00 00    	mov    0xdf0,%edx
 ...
 90c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 90f:	89 15 f0 0d 00 00    	mov    %edx,0xdf0
}
 ...
 91f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 920:	c7 05 f0 0d 00 00 f4 	movl   $0xdf4,0xdf0
 927:	0d 00 00 
    base.s.size = 0;
 92a:	bf f4 0d 00 00       	mov    $0xdf4,%edi
    base.s.ptr = freep = prevp = &base;
 92f:	c7 05 f4 0d 00 00 f4 	movl   $0xdf4,0xdf4
 936:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 939:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 93b:	c7 05 f8 0d 00 00 00 	movl   $0x0,0xdf8
 942:	00 00 00 
    if(p->s.size >= nunits){
