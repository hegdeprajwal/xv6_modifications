...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 a8 39 00 00       	call   39d3 <open>
    ...
    exit();
      40:	e8 4e 39 00 00       	call   3993 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 7d 39 00 00       	call   39d3 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 5d 39 00 00       	call   39bb <close>
  ...
  exit();
     10d:	e8 81 38 00 00       	call   3993 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 ad 38 00 00       	call   3a03 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 75 38 00 00       	call   39e3 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 81 38 00 00       	call   3a03 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 c0 5f 00 00    	push   0x5fc0
     1ae:	e8 4d 39 00 00       	call   3b00 <printf>
    exit();
     1b3:	e8 db 37 00 00       	call   3993 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 73 3e 00 00       	push   $0x3e73
     1bf:	ff 35 c0 5f 00 00    	push   0x5fc0
     1c5:	e8 36 39 00 00       	call   3b00 <printf>
    exit();
     1ca:	e8 c4 37 00 00       	call   3993 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 57 3e 00 00       	push   $0x3e57
     1d6:	ff 35 c0 5f 00 00    	push   0x5fc0
     1dc:	e8 1f 39 00 00       	call   3b00 <printf>
    exit();
     1e1:	e8 ad 37 00 00       	call   3993 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 36 3e 00 00       	push   $0x3e36
     1ed:	ff 35 c0 5f 00 00    	push   0x5fc0
     1f3:	e8 08 39 00 00       	call   3b00 <printf>
    exit();
     1f8:	e8 96 37 00 00       	call   3993 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 c0 5f 00 00    	push   0x5fc0
     211:	e8 ea 38 00 00       	call   3b00 <printf>
  pid = fork();
     216:	e8 70 37 00 00       	call   398b <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 c6 37 00 00       	call   39fb <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 b6 37 00 00       	call   3a03 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 7e 37 00 00       	call   39e3 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 22 37 00 00       	call   3993 <exit>
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 c0 5f 00 00    	push   0x5fc0
     ...
     2a0:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    exit();
     ...
     2ce:	ff 35 c0 5f 00 00    	push   0x5fc0
     ...
     2e5:	ff 35 c0 5f 00 00    	push   0x5fc0
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 8c 36 00 00       	call   39d3 <open>
    if(fd >= 0){
     ...
     356:	ff 35 c0 5f 00 00    	push   0x5fc0
     35c:	e8 9f 37 00 00       	call   3b00 <printf>
      exit();
     361:	e8 2d 36 00 00       	call   3993 <exit>
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 c0 5f 00 00    	push   0x5fc0
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 c0 5f 00 00    	push   0x5fc0
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 af 35 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 87 35 00 00       	call   39bb <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 25 3f 00 00       	push   $0x3f25
     43d:	e8 91 35 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 c0 5f 00 00    	push   0x5fc0
     46e:	e8 8d 36 00 00       	call   3b00 <printf>
    exit();
     473:	e8 1b 35 00 00       	call   3993 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 32 3f 00 00       	push   $0x3f32
     47f:	ff 35 c0 5f 00 00    	push   0x5fc0
     485:	e8 76 36 00 00       	call   3b00 <printf>
    exit();
     48a:	e8 04 35 00 00       	call   3993 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 c0 5f 00 00    	push   0x5fc0
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 1a 35 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 c3 34 00 00       	call   39b3 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 a7 34 00 00       	call   39b3 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 c0 5f 00 00    	push   0x5fc0
     52e:	e8 cd 35 00 00       	call   3b00 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 80 34 00 00       	call   39bb <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 6f 3f 00 00       	push   $0x3f6f
     544:	e8 8a 34 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 c0 5f 00 00    	push   0x5fc0
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 2f 34 00 00       	call   39ab <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 c0 5f 00 00    	push   0x5fc0
     598:	e8 63 35 00 00       	call   3b00 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 16 34 00 00       	call   39bb <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 6f 3f 00 00 	movl   $0x3f6f,(%esp)
     5ac:	e8 32 34 00 00       	call   39e3 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 c0 5f 00 00    	push   0x5fc0
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 c0 5f 00 00    	push   0x5fc0
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 3a 33 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 ea 32 00 00       	call   39b3 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 d0 32 00 00       	call   39bb <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 b7 40 00 00       	push   $0x40b7
     6f4:	e8 da 32 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 71 32 00 00       	call   39ab <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 65 32 00 00       	call   39bb <close>
  if(unlink("big") < 0){
     756:	c7 04 24 b7 40 00 00 	movl   $0x40b7,(%esp)
     75d:	e8 81 32 00 00       	call   39e3 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 c0 5f 00 00    	push   0x5fc0
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 c0 5f 00 00    	push   0x5fc0
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 48 31 00 00       	call   39d3 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 28 31 00 00       	call   39bb <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 1d 31 00 00       	call   39e3 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 c0 5f 00 00    	push   0x5fc0
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 dd 30 00 00       	call   3a03 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 c5 30 00 00       	call   3a03 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 91 30 00 00       	call   39e3 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 c0 5f 00 00    	push   0x5fc0
     97e:	e8 7d 31 00 00       	call   3b00 <printf>
    exit();
     983:	e8 0b 30 00 00       	call   3993 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 21 41 00 00       	push   $0x4121
     98f:	ff 35 c0 5f 00 00    	push   0x5fc0
     995:	e8 66 31 00 00       	call   3b00 <printf>
    exit();
     99a:	e8 f4 2f 00 00       	call   3993 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 10 41 00 00       	push   $0x4110
     9a6:	ff 35 c0 5f 00 00    	push   0x5fc0
     9ac:	e8 4f 31 00 00       	call   3b00 <printf>
    exit();
     9b1:	e8 dd 2f 00 00       	call   3993 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 fd 40 00 00       	push   $0x40fd
     9bd:	ff 35 c0 5f 00 00    	push   0x5fc0
     9c3:	e8 38 31 00 00       	call   3b00 <printf>
    exit();
     9c8:	e8 c6 2f 00 00       	call   3993 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 c0 5f 00 00    	push   0x5fc0
     9e1:	e8 1a 31 00 00       	call   3b00 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 c4 5f 00 00       	push   $0x5fc4
     9ed:	68 0d 3f 00 00       	push   $0x3f0d
     9f2:	e8 d4 2f 00 00       	call   39cb <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 c0 5f 00 00    	push   0x5fc0
     a0d:	e8 ee 30 00 00       	call   3b00 <printf>
    exit();
     a12:	e8 7c 2f 00 00       	call   3993 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 59 2f 00 00       	call   39bb <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 2e 2f 00 00       	call   39ab <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 df 2e 00 00       	call   39bb <close>
     ...
     b11:	e8 9d 2e 00 00       	call   39b3 <write>
    ...
    exit();
     b28:	e8 66 2e 00 00       	call   3993 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 7a 2e 00 00       	call   39bb <close>
    wait();
     b41:	e8 55 2e 00 00       	call   399b <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 94 2f 00 00       	call   3b00 <printf>
      exit();
     b6c:	e8 22 2e 00 00       	call   3993 <exit>
    ...
    exit();
     b7f:	e8 0f 2e 00 00       	call   3993 <exit>
    ...
    exit();
     b92:	e8 fc 2d 00 00       	call   3993 <exit>
     ...
     ba0:	e8 5b 2f 00 00       	call   3b00 <printf>
        exit();
     ba5:	e8 e9 2d 00 00       	call   3993 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 c1 2d 00 00       	call   398b <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 ac 2d 00 00       	call   398b <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 a7 2d 00 00       	call   39a3 <pipe>
  pid3 = fork();
     bfc:	e8 8a 2d 00 00       	call   398b <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 7d 2d 00 00       	call   39bb <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 40 2d 00 00       	call   39bb <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 32 2d 00 00       	call   39c3 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 2a 2d 00 00       	call   39c3 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 22 2d 00 00       	call   39c3 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 e7 2c 00 00       	call   399b <wait>
  wait();
     cb4:	e8 e2 2c 00 00       	call   399b <wait>
  wait();
     cb9:	e8 dd 2c 00 00       	call   399b <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 74 2c 00 00       	call   399b <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 56 2c 00 00       	call   398b <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 04 2c 00 00       	call   3993 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 68 2c 00 00       	call   3a13 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 d9 2b 00 00       	call   398b <fork>
    ...
    exit();
     e1f:	e8 6f 2b 00 00       	call   3993 <exit>
     ...
     e3a:	e8 84 2b 00 00       	call   39c3 <kill>
      exit();
     e3f:	e8 4f 2b 00 00       	call   3993 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 48 2b 00 00       	jmp    399b <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 62 2b 00 00       	call   39e3 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 63 42 00 00       	push   $0x4263
     e8d:	e8 41 2b 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 df 2a 00 00       	call   398b <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 d2 2a 00 00       	call   39b3 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 90 2a 00 00       	call   399b <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 a2 2a 00 00       	call   39bb <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 63 42 00 00       	push   $0x4263
     f22:	e8 ac 2a 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 5a 2a 00 00       	call   39ab <read>
  ...
  close(fd);
     ...
     f86:	e8 30 2a 00 00       	call   39bb <close>
  unlink("sharedfd");
     f8b:	c7 04 24 63 42 00 00 	movl   $0x4263,(%esp)
     f92:	e8 4c 2a 00 00       	call   39e3 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 93 29 00 00       	call   3993 <exit>
    ...
    exit();
    100e:	e8 80 29 00 00       	call   3993 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 7f 29 00 00       	call   39e3 <unlink>
    pid = fork();
    1064:	e8 22 29 00 00       	call   398b <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 0e 29 00 00       	call   399b <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 07 29 00 00       	call   399b <wait>
    1094:	e8 02 29 00 00       	call   399b <wait>
    1099:	e8 fd 28 00 00       	call   399b <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 21 29 00 00       	call   39d3 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 d6 28 00 00       	call   39ab <read>
    ...
    1104:	e8 b2 28 00 00       	call   39bb <close>
    if(total != 12*500){
    ...
    111e:	e8 c0 28 00 00       	call   39e3 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 a2 29 00 00       	call   3b00 <printf>
          exit();
    115e:	e8 30 28 00 00       	call   3993 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 62 28 00 00       	call   39d3 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 08 28 00 00       	call   39b3 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 d4 27 00 00       	call   3993 <exit>
    ...
    11c8:	e8 33 29 00 00       	call   3b00 <printf>
        exit();
    11cd:	e8 c1 27 00 00       	call   3993 <exit>
    ...
    11e2:	e8 19 29 00 00       	call   3b00 <printf>
      exit();
    11e7:	e8 a7 27 00 00       	call   3993 <exit>
    ...
    11f5:	e8 06 29 00 00       	call   3b00 <printf>
      exit();
    11fa:	e8 94 27 00 00       	call   3993 <exit>
    ...
    1208:	e8 f3 28 00 00       	call   3b00 <printf>
          exit();
    120d:	e8 81 27 00 00       	call   3993 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 4c 27 00 00       	call   398b <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 41 27 00 00       	call   399b <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 37 27 00 00       	call   399b <wait>
    1264:	e8 32 27 00 00       	call   399b <wait>
    1269:	e8 2d 27 00 00       	call   399b <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 25 27 00 00       	call   39d3 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 e9 26 00 00       	call   39bb <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 d3 26 00 00       	call   39e3 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 ae 27 00 00       	call   3b00 <printf>
        exit();
    1352:	e8 3c 26 00 00       	call   3993 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 34 26 00 00       	call   39d3 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 0c 26 00 00       	call   39bb <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 15 26 00 00       	call   39e3 <unlink>
    ...
    13de:	e8 1d 27 00 00       	call   3b00 <printf>
            exit();
    13e3:	e8 ab 25 00 00       	call   3993 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 9e 25 00 00       	call   3993 <exit>
    ...
    1400:	e8 fb 26 00 00       	call   3b00 <printf>
        exit();
    1405:	e8 89 25 00 00       	call   3993 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 e7 26 00 00       	call   3b00 <printf>
      exit();
    1419:	e8 75 25 00 00       	call   3993 <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 d3 26 00 00       	call   3b00 <printf>
          exit();
    142d:	e8 61 25 00 00       	call   3993 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 6e 25 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 31 25 00 00       	call   39b3 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 31 25 00 00       	call   39bb <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 15 43 00 00       	push   $0x4315
    1493:	e8 3b 25 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 31 25 00 00       	call   39e3 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 04 25 00 00       	call   39d3 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 92 24 00 00       	call   39b3 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 89 24 00 00       	call   39bb <close>
  unlink("unlinkread");
    1532:	c7 04 24 15 43 00 00 	movl   $0x4315,(%esp)
    1539:	e8 a5 24 00 00       	call   39e3 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 2a 24 00 00       	call   3993 <exit>
    ...
    exit();
    1577:	e8 17 24 00 00       	call   3993 <exit>
    ...
    exit();
    158a:	e8 04 24 00 00       	call   3993 <exit>
    ...
    exit();
    159d:	e8 f1 23 00 00       	call   3993 <exit>
    ...
    exit();
    15b0:	e8 de 23 00 00       	call   3993 <exit>
    ...
    exit();
    15c3:	e8 cb 23 00 00       	call   3993 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 8a 23 00 00       	call   39b3 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 7d 23 00 00       	call   39bb <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 da 43 00 00       	push   $0x43da
    1645:	68 d6 43 00 00       	push   $0x43d6
    164a:	e8 a4 23 00 00       	call   39f3 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 7c 23 00 00       	call   39e3 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 d6 43 00 00       	push   $0x43d6
    1670:	e8 5e 23 00 00       	call   39d3 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 44 23 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 fc 22 00 00       	call   39ab <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 f7 22 00 00       	call   39bb <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 da 43 00 00       	push   $0x43da
    16cb:	68 da 43 00 00       	push   $0x43da
    16d0:	e8 1e 23 00 00       	call   39f3 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 f6 22 00 00       	call   39e3 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 d6 43 00 00       	push   $0x43d6
    16f4:	68 da 43 00 00       	push   $0x43da
    16f9:	e8 f5 22 00 00       	call   39f3 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 dc 22 00 00       	call   39f3 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 4b 22 00 00       	call   3993 <exit>
    ...
    exit();
    1756:	e8 38 22 00 00       	call   3993 <exit>
    ...
    exit();
    1769:	e8 25 22 00 00       	call   3993 <exit>
    ...
    exit();
    177c:	e8 12 22 00 00       	call   3993 <exit>
    ...
    exit();
    178f:	e8 ff 21 00 00       	call   3993 <exit>
    ...
    exit();
    17a2:	e8 ec 21 00 00       	call   3993 <exit>
    ...
    exit();
    17b5:	e8 d9 21 00 00       	call   3993 <exit>
    ...
    exit();
    17c8:	e8 c6 21 00 00       	call   3993 <exit>
    ...
    exit();
    17db:	e8 b3 21 00 00       	call   3993 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 a4 21 00 00       	call   39d3 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 79 21 00 00       	call   39bb <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 51 21 00 00       	call   399b <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 81 21 00 00       	call   39e3 <unlink>
    pid = fork();
    1862:	e8 24 21 00 00       	call   398b <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 49 21 00 00       	call   39d3 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 12 21 00 00       	call   39f3 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 b2 20 00 00       	call   399b <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 c0 20 00 00       	call   39d3 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 7f 20 00 00       	call   39ab <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 42 20 00 00       	call   39bb <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 41 20 00 00       	call   39e3 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 39 20 00 00       	call   39e3 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 31 20 00 00       	call   39e3 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 29 20 00 00       	call   39e3 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 d1 1f 00 00       	call   399b <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 aa 1f 00 00       	call   398b <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 c3 1f 00 00       	call   39d3 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 a3 1f 00 00       	call   39bb <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 b1 1f 00 00       	call   39d3 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 91 1f 00 00       	call   39bb <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 9f 1f 00 00       	call   39d3 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 7f 1f 00 00       	call   39bb <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 8d 1f 00 00       	call   39d3 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 6d 1f 00 00       	call   39bb <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 7a 20 00 00       	call   3b00 <printf>
      exit();
    1a86:	e8 08 1f 00 00       	call   3993 <exit>
    ...
    exit();
    1a99:	e8 f5 1e 00 00       	call   3993 <exit>
    ...
    1aac:	e8 4f 20 00 00       	call   3b00 <printf>
        exit();
    1ab1:	e8 dd 1e 00 00       	call   3993 <exit>
    ...
    1ac4:	e8 37 20 00 00       	call   3b00 <printf>
        exit();
    1ac9:	e8 c5 1e 00 00       	call   3993 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 e4 1e 00 00       	call   39bb <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 e2 1e 00 00       	call   39e3 <unlink>
  pid = fork();
    1b01:	e8 85 1e 00 00       	call   398b <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 a1 1e 00 00       	call   39e3 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 58 1e 00 00       	call   39d3 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 38 1e 00 00       	call   39bb <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 04 1e 00 00       	call   399b <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 31 1e 00 00       	call   39f3 <link>
    ...
    exit();
    1bd8:	e8 b6 1d 00 00       	call   3993 <exit>
    exit();
    1bdd:	e8 b1 1d 00 00       	call   3993 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 d2 1d 00 00       	call   39e3 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 25 45 00 00       	push   $0x4525
    1c1d:	e8 b1 1d 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 80 1d 00 00       	call   39bb <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 87 1d 00 00       	call   39f3 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 56 1d 00 00       	call   39e3 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 2c 1d 00 00       	call   39e3 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 0e 1e 00 00       	call   3b00 <printf>
      exit();
    1cf2:	e8 9c 1c 00 00       	call   3993 <exit>
    ...
    1d01:	e8 fa 1d 00 00       	call   3b00 <printf>
      exit();
    1d06:	e8 88 1c 00 00       	call   3993 <exit>
    ...
    exit();
    1d19:	e8 75 1c 00 00       	call   3993 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 a4 1c 00 00       	call   39e3 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d46:	e8 b0 1c 00 00       	call   39fb <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 6b 1c 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 2e 1c 00 00       	call   39b3 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 2e 1c 00 00       	call   39bb <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d94:	e8 4a 1c 00 00       	call   39e3 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 4a 1c 00 00       	call   39fb <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 05 1c 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 c8 1b 00 00       	call   39b3 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 c8 1b 00 00       	call   39bb <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 f2 45 00 00       	push   $0x45f2
    1dfc:	e8 d2 1b 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 8a 1b 00 00       	call   39ab <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 78 1b 00 00       	call   39bb <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 32 46 00 00       	push   $0x4632
    1e4a:	68 ce 45 00 00       	push   $0x45ce
    1e4f:	e8 9f 1b 00 00       	call   39f3 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 77 1b 00 00       	call   39e3 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 4d 1b 00 00       	call   39d3 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 65 1b 00 00       	call   3a03 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 4d 1b 00 00       	call   3a03 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 35 1b 00 00       	call   3a03 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 1d 1b 00 00       	call   3a03 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 d3 1a 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 8b 1a 00 00       	call   39ab <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 86 1a 00 00       	call   39bb <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 ce 45 00 00       	push   $0x45ce
    1f3e:	e8 90 1a 00 00       	call   39d3 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 73 1a 00 00       	call   39d3 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 56 1a 00 00       	call   39d3 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 39 1a 00 00       	call   39d3 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 1f 1a 00 00       	call   39d3 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 05 1a 00 00       	call   39d3 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 08 1a 00 00       	call   39f3 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 eb 19 00 00       	call   39f3 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 ce 19 00 00       	call   39f3 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 be 19 00 00       	call   39fb <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 a6 19 00 00       	call   39fb <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 8e 19 00 00       	call   39fb <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 5e 19 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 46 19 00 00       	call   39e3 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 4e 19 00 00       	call   3a03 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 36 19 00 00       	call   3a03 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 fe 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 e6 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 ce 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 b6 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 9e 18 00 00       	call   39e3 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 19 18 00 00       	call   3993 <exit>
    ...
    exit();
    2188:	e8 06 18 00 00       	call   3993 <exit>
    ...
    exit();
    219b:	e8 f3 17 00 00       	call   3993 <exit>
    ...
    exit();
    21ae:	e8 e0 17 00 00       	call   3993 <exit>
    ...
    exit();
    21c1:	e8 cd 17 00 00       	call   3993 <exit>
    ...
    exit();
    21d4:	e8 ba 17 00 00       	call   3993 <exit>
    ...
    exit();
    21e7:	e8 a7 17 00 00       	call   3993 <exit>
    ...
    exit();
    21fa:	e8 94 17 00 00       	call   3993 <exit>
    ...
    exit();
    220d:	e8 81 17 00 00       	call   3993 <exit>
    ...
    exit();
    2220:	e8 6e 17 00 00       	call   3993 <exit>
    ...
    exit();
    2233:	e8 5b 17 00 00       	call   3993 <exit>
    ...
    exit();
    2246:	e8 48 17 00 00       	call   3993 <exit>
    ...
    exit();
    2259:	e8 35 17 00 00       	call   3993 <exit>
    ...
    exit();
    226c:	e8 22 17 00 00       	call   3993 <exit>
    ...
    exit();
    227f:	e8 0f 17 00 00       	call   3993 <exit>
    ...
    exit();
    2292:	e8 fc 16 00 00       	call   3993 <exit>
    ...
    exit();
    22a5:	e8 e9 16 00 00       	call   3993 <exit>
    ...
    exit();
    22b8:	e8 d6 16 00 00       	call   3993 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 c3 16 00 00       	call   3993 <exit>
    ...
    exit();
    22de:	e8 b0 16 00 00       	call   3993 <exit>
    ...
    exit();
    22f1:	e8 9d 16 00 00       	call   3993 <exit>
    ...
    exit();
    2304:	e8 8a 16 00 00       	call   3993 <exit>
    ...
    exit();
    2317:	e8 77 16 00 00       	call   3993 <exit>
    ...
    exit();
    232a:	e8 64 16 00 00       	call   3993 <exit>
    ...
    exit();
    233d:	e8 51 16 00 00       	call   3993 <exit>
    ...
    exit();
    2350:	e8 3e 16 00 00       	call   3993 <exit>
    ...
    exit();
    2363:	e8 2b 16 00 00       	call   3993 <exit>
    ...
    exit();
    2376:	e8 18 16 00 00       	call   3993 <exit>
    ...
    exit();
    2389:	e8 05 16 00 00       	call   3993 <exit>
    ...
    exit();
    239c:	e8 f2 15 00 00       	call   3993 <exit>
    ...
    exit();
    23af:	e8 df 15 00 00       	call   3993 <exit>
    ...
    exit();
    23c2:	e8 cc 15 00 00       	call   3993 <exit>
    ...
    exit();
    23d5:	e8 b9 15 00 00       	call   3993 <exit>
    ...
    exit();
    23e8:	e8 a6 15 00 00       	call   3993 <exit>
    ...
    exit();
    23fb:	e8 93 15 00 00       	call   3993 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 be 15 00 00       	call   39e3 <unlink>
    ...
    243d:	e8 91 15 00 00       	call   39d3 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 59 15 00 00       	call   39b3 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 43 15 00 00       	call   39b3 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 35 15 00 00       	call   39bb <close>
    unlink("bigwrite");
    2486:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    248d:	e8 51 15 00 00       	call   39e3 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 3c 16 00 00       	call   3b00 <printf>
        exit();
    24c4:	e8 ca 14 00 00       	call   3993 <exit>
    ...
    24d3:	e8 28 16 00 00       	call   3b00 <printf>
      exit();
    24d8:	e8 b6 14 00 00       	call   3993 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 e2 14 00 00       	call   39e3 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 f0 48 00 00       	push   $0x48f0
    250d:	e8 c1 14 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 65 14 00 00       	call   39b3 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 4e 14 00 00       	call   39bb <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 f0 48 00 00       	push   $0x48f0
    2576:	e8 58 14 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 da 13 00 00       	call   39ab <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 d8 13 00 00       	call   39bb <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 e4 13 00 00       	call   39e3 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 d9 14 00 00       	call   3b00 <printf>
      exit();
    2627:	e8 67 13 00 00       	call   3993 <exit>
    ...
    2636:	e8 c5 14 00 00       	call   3b00 <printf>
      exit();
    263b:	e8 53 13 00 00       	call   3993 <exit>
    ...
    264a:	e8 b1 14 00 00       	call   3b00 <printf>
      exit();
    264f:	e8 3f 13 00 00       	call   3993 <exit>
    ...
    265e:	e8 9d 14 00 00       	call   3b00 <printf>
      exit();
    2663:	e8 2b 13 00 00       	call   3993 <exit>
    ...
    exit();
    2676:	e8 18 13 00 00       	call   3993 <exit>
    ...
    exit();
    2689:	e8 05 13 00 00       	call   3993 <exit>
    ...
    exit();
    269c:	e8 f2 12 00 00       	call   3993 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 2d 13 00 00       	call   39fb <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 15 13 00 00       	call   39fb <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 d0 12 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 a4 12 00 00       	call   39bb <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 48 52 00 00       	push   $0x5248
    2720:	e8 ae 12 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 86 12 00 00       	call   39bb <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 bc 49 00 00 	movl   $0x49bc,(%esp)
    273c:	e8 ba 12 00 00       	call   39fb <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 a6 12 00 00       	call   39fb <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 10 12 00 00       	call   3993 <exit>
    ...
    exit();
    2791:	e8 fd 11 00 00       	call   3993 <exit>
    ...
    exit();
    27a4:	e8 ea 11 00 00       	call   3993 <exit>
    ...
    exit();
    27b7:	e8 d7 11 00 00       	call   3993 <exit>
    ...
    exit();
    27ca:	e8 c4 11 00 00       	call   3993 <exit>
    ...
    exit();
    27dd:	e8 b1 11 00 00       	call   3993 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 ed 11 00 00       	call   39fb <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 dd 11 00 00       	call   3a03 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 a5 11 00 00       	call   39e3 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 8d 11 00 00       	call   39e3 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 95 11 00 00       	call   3a03 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 5d 11 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 49 11 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 35 11 00 00       	call   39e3 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 b7 10 00 00       	call   3993 <exit>
    ...
    exit();
    28ea:	e8 a4 10 00 00       	call   3993 <exit>
    ...
    exit();
    28fd:	e8 91 10 00 00       	call   3993 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 7e 10 00 00       	call   3993 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 6b 10 00 00       	call   3993 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 58 10 00 00       	call   3993 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 45 10 00 00       	call   3993 <exit>
    ...
    exit();
    295c:	e8 32 10 00 00       	call   3993 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 3f 10 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 13 10 00 00       	call   39bb <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 a5 4a 00 00 	movl   $0x4aa5,(%esp)
    29af:	e8 4f 10 00 00       	call   3a03 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 05 10 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 e8 0f 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 f8 0f 00 00       	call   39fb <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 c8 0f 00 00       	call   39e3 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 bb 0f 00 00       	call   39f3 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 93 0f 00 00       	call   39e3 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 69 0f 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 4f 0f 00 00       	call   39d3 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 1d 0f 00 00       	call   39b3 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 15 0f 00 00       	call   39bb <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 c4 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2add:	e8 b1 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2af0:	e8 9e 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b03:	e8 8b 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b16:	e8 78 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b29:	e8 65 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b3c:	e8 52 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b4f:	e8 3f 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b62:	e8 2c 0e 00 00       	call   3993 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 5e 0e 00 00       	call   39fb <mkdir>
    ...
    2bb0:	e8 4e 0e 00 00       	call   3a03 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 97 0d 00 00       	call   39bb <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 80 47 00 00       	push   $0x4780
    2c2f:	e8 af 0d 00 00       	call   39e3 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 b6 0d 00 00       	call   3a03 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 8e 0e 00 00       	call   3b00 <printf>
      exit();
    2c72:	e8 1c 0d 00 00       	call   3993 <exit>
    ...
    2c81:	e8 7a 0e 00 00       	call   3b00 <printf>
      exit();
    2c86:	e8 08 0d 00 00       	call   3993 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 c9 0c 00 00       	call   398b <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 c6 0c 00 00       	call   399b <wait>
  ...
  if(wait() != -1){
    2cde:	e8 b8 0c 00 00       	call   399b <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 92 0c 00 00       	call   3993 <exit>
    ...
    2d0b:	e8 f0 0d 00 00       	call   3b00 <printf>
      exit();
    2d10:	e8 7e 0c 00 00       	call   3993 <exit>
    ...
    exit();
    2d23:	e8 6b 0c 00 00       	call   3993 <exit>
    ...
    exit();
    2d36:	e8 58 0c 00 00       	call   3993 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 8f 0c 00 00       	call   3a1b <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 de 0b 00 00       	call   398b <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 57 0c 00 00       	call   3a1b <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 4b 0c 00 00       	call   3a1b <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 b3 0b 00 00       	call   399b <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 29 0c 00 00       	call   3a1b <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 18 0c 00 00       	call   3a1b <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 03 0c 00 00       	call   3a1b <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 f5 0b 00 00       	call   3a1b <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 df 0b 00 00       	call   3a1b <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 c4 0b 00 00       	call   3a1b <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 b6 0b 00 00       	call   3a1b <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 9f 0b 00 00       	call   3a1b <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 36 0b 00 00       	call   3a13 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 a7 0a 00 00       	call   398b <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 a4 0a 00 00       	call   399b <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 92 0a 00 00       	call   39a3 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 5e 0a 00 00       	call   398b <fork>
    ...
    2f48:	e8 5e 0a 00 00       	call   39ab <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 b7 0a 00 00       	call   3a1b <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 43 0a 00 00       	call   39c3 <kill>
    wait();
    2f80:	e8 16 0a 00 00       	call   399b <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 79 0a 00 00       	call   3a1b <sbrk>
    2fa2:	83 c4 10             	add    $0x10,%esp
    2fa5:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fa8:	72 68                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2faa:	83 ec 08             	sub    $0x8,%esp
    2fad:	68 c0 4c 00 00       	push   $0x4cc0
    2fb2:	ff 35 c0 5f 00 00    	push   0x5fc0
    2fb8:	e8 43 0b 00 00       	call   3b00 <printf>
}
    ...
    exit();
    310c:	e8 82 08 00 00       	call   3993 <exit>
    exit();
    3111:	e8 7d 08 00 00       	call   3993 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 55 4c 00 00       	push   $0x4c55
    311d:	ff 35 c0 5f 00 00    	push   0x5fc0
    3123:	e8 d8 09 00 00       	call   3b00 <printf>
    exit();
    3128:	e8 66 08 00 00       	call   3993 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 14 54 00 00       	push   $0x5414
    3134:	ff 35 c0 5f 00 00    	push   0x5fc0
    313a:	e8 c1 09 00 00       	call   3b00 <printf>
    exit();
    313f:	e8 4f 08 00 00       	call   3993 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 dc 53 00 00       	push   $0x53dc
    314b:	ff 35 c0 5f 00 00    	push   0x5fc0
    3151:	e8 aa 09 00 00       	call   3b00 <printf>
    exit();
    3156:	e8 38 08 00 00       	call   3993 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 71 4c 00 00       	push   $0x4c71
    3162:	ff 35 c0 5f 00 00    	push   0x5fc0
    3168:	e8 93 09 00 00       	call   3b00 <printf>
    exit();
    316d:	e8 21 08 00 00       	call   3993 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 5e 08 00 00       	call   3a23 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 52 08 00 00       	call   3a23 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 ea 07 00 00       	call   39c3 <kill>
    wait();
    31d9:	e8 bd 07 00 00       	call   399b <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 dd 4c 00 00       	push   $0x4cdd
    31e6:	e8 08 08 00 00       	call   39f3 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 70 07 00 00       	call   3993 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 e8 4c 00 00       	push   $0x4ce8
    322b:	ff 35 c0 5f 00 00    	push   0x5fc0
    3231:	e8 ca 08 00 00       	call   3b00 <printf>
      exit();
    3236:	e8 58 07 00 00       	call   3993 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 c0 5f 00 00    	push   0x5fc0
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    3293:	ff 35 c0 5f 00 00    	push   0x5fc0
    3299:	e8 62 08 00 00       	call   3b00 <printf>
      exit();
    329e:	e8 f0 06 00 00       	call   3993 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 23 07 00 00       	call   39e3 <unlink>
  pid = fork();
    32c0:	e8 c6 06 00 00       	call   398b <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 c4 06 00 00       	call   399b <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 36 4d 00 00       	push   $0x4d36
    32e1:	e8 ed 06 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 c1 06 00 00       	call   39bb <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 36 4d 00 00 	movl   $0x4d36,(%esp)
    3301:	e8 dd 06 00 00       	call   39e3 <unlink>
}
    ...
    332a:	ff 35 c0 5f 00 00    	push   0x5fc0
    args[MAXARG-1] = 0;
    ...
    334b:	e8 7b 06 00 00       	call   39cb <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 4d 4d 00 00       	push   $0x4d4d
    3357:	ff 35 c0 5f 00 00    	push   0x5fc0
    ...
    336e:	e8 60 06 00 00       	call   39d3 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 40 06 00 00       	call   39bb <close>
    exit();
    337b:	e8 13 06 00 00       	call   3993 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 76 4d 00 00       	push   $0x4d76
    3387:	ff 35 c0 5f 00 00    	push   0x5fc0
    338d:	e8 6e 07 00 00       	call   3b00 <printf>
    exit();
    3392:	e8 fc 05 00 00       	call   3993 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 5d 4d 00 00       	push   $0x4d5d
    339e:	ff 35 c0 5f 00 00    	push   0x5fc0
    33a4:	e8 57 07 00 00       	call   3b00 <printf>
    exit();
    33a9:	e8 e5 05 00 00       	call   3993 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 75 05 00 00       	call   39d3 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 2e 05 00 00       	call   39b3 <write>
      if(cc < 512)
    ...
    34a2:	e8 14 05 00 00       	call   39bb <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 92 04 00 00       	call   39e3 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 f4 03 00 00       	call   398b <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 f6 03 00 00       	call   399b <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 b6 03 00 00       	call   3993 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 a3 03 00 00       	call   3993 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 d0 03 00 00       	call   39d3 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 05 04 00 00       	call   3a1b <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 86 03 00 00       	call   39ab <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 8e 03 00 00       	call   39bb <close>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 ee 01 00 00       	call   39ab <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 b1 01 00 00       	call   39d3 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 b4 01 00 00       	call   39eb <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 7a 01 00 00       	call   39bb <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
  ...
  return clone(start_routine, arg1, arg2, stack);
    ...
    38ea:	e8 44 01 00 00       	call   3a33 <clone>
}
    38ef:	c9                   	leave  
    38f0:	c3                   	ret    
...
thread_join() 
{
    ...
    3903:	83 ec 34             	sub    $0x34,%esp
  void *stack;
  int ret_pid = join(&stack);
    3906:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3909:	50                   	push   %eax
    390a:	e8 2c 01 00 00       	call   3a3b <join>

  if (ret_pid != -1) 
    390f:	83 c4 10             	add    $0x10,%esp
    3912:	83 f8 ff             	cmp    $0xffffffff,%eax
    3915:	75 09                	jne    3920 <thread_join+0x20>
    free(stack);
  }
  ...
  return ret_pid;
    ...
    3923:	ff 75 f4             	push   -0xc(%ebp)
    3926:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3929:	e8 72 03 00 00       	call   3ca0 <free>
    392e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
void lock_init(lock_t *lock)
{
  ...
  lock->ticket = 0;
    3946:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  lock->turn = 0;
    394d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    3953:	5d                   	pop    %ebp
    3954:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
    ...
    __asm__ volatile
    396b:	f0 0f c1 42 04       	lock xadd %eax,0x4(%edx)
  int myTurn = fetch_and_add(&lock->ticket , 1);
  while ( lock->turn != myTurn) 
    3970:	8b 12                	mov    (%edx),%edx
    3972:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3978:	39 c2                	cmp    %eax,%edx
    397a:	75 fc                	jne    3978 <lock_acquire+0x18>
  {}; // keep spinning
}
    397c:	5d                   	pop    %ebp
    397d:	c3                   	ret    
...
00003a33 <clone>:
SYSCALL(clone)
    3a33:	b8 16 00 00 00       	mov    $0x16,%eax
    3a38:	cd 40                	int    $0x40
    3a3a:	c3                   	ret    

00003a3b <join>:
    3a3b:	b8 17 00 00 00       	mov    $0x17,%eax
    3a40:	cd 40                	int    $0x40
    3a42:	c3                   	ret    
    ...
    3b09:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b45:	57                   	push   %edi
    3b46:	56                   	push   %esi
    3b47:	e8 67 fe ff ff       	call   39b3 <write>
  ...
  write(fd, &c, 1);
    ...
    3b9e:	e8 10 fe ff ff       	call   39b3 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3baf:	57                   	push   %edi
    3bb0:	56                   	push   %esi
    3bb1:	e8 fd fd ff ff       	call   39b3 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3c1b:	57                   	push   %edi
    3c1c:	56                   	push   %esi
    3c1d:	e8 91 fd ff ff       	call   39b3 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c5f:	e8 4f fd ff ff       	call   39b3 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d93:	e8 83 fc ff ff       	call   3a1b <sbrk>
  if(p == (char*)-1)
