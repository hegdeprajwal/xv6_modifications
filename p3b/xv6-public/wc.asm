...
main(int argc, char *argv[])
{
  ...
  59:	e8 5d 04 00 00       	call   4bb <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 28 04 00 00       	call   493 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 86 05 00 00       	call   600 <printf>
      exit();
  7a:	e8 14 04 00 00       	call   493 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 01 04 00 00       	call   493 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 d6 03 00 00       	call   4ab <read>
 ...
 16f:	e8 8c 04 00 00       	call   600 <printf>
    exit();
 174:	e8 1a 03 00 00       	call   493 <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 ee 01 00 00       	call   4ab <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 b1 01 00 00       	call   4d3 <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 b4 01 00 00       	call   4eb <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 7a 01 00 00       	call   4bb <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 3ea:	e8 44 01 00 00       	call   533 <clone>
}
 3ef:	c9                   	leave  
 3f0:	c3                   	ret    
...
thread_join() 
{
 ...
 403:	83 ec 34             	sub    $0x34,%esp
  void *stack;
  int ret_pid = join(&stack);
 406:	8d 45 f4             	lea    -0xc(%ebp),%eax
 409:	50                   	push   %eax
 40a:	e8 2c 01 00 00       	call   53b <join>

  if (ret_pid != -1) 
 40f:	83 c4 10             	add    $0x10,%esp
 412:	83 f8 ff             	cmp    $0xffffffff,%eax
 415:	75 09                	jne    420 <thread_join+0x20>
    free(stack);
  }
 ...
 423:	ff 75 f4             	push   -0xc(%ebp)
 426:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 429:	e8 72 03 00 00       	call   7a0 <free>
...
void lock_init(lock_t *lock)
{
 ...
 443:	8b 45 08             	mov    0x8(%ebp),%eax
  lock->ticket = 0;
 446:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
  lock->turn = 0;
 44d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 453:	5d                   	pop    %ebp
 454:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 470:	8b 12                	mov    (%edx),%edx
 472:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 478:	39 c2                	cmp    %eax,%edx
 47a:	75 fc                	jne    478 <lock_acquire+0x18>
  {}; // keep spinning
}
 47c:	5d                   	pop    %ebp
 47d:	c3                   	ret    
